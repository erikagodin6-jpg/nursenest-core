 ...
 * Usage:
 *   node public/clinical-skills-workstation-preview/figma-capture-clinical-skills.mjs <captureId> [hub|lesson] [theme] [--mobile]
 *
 * Examples:
 *   node public/clinical-skills-workstation-preview/figma-capture-clinical-skills.mjs nn-clinical-skills-hub-ocean-2026 hub ocean
 *   node public/clinical-skills-workstation-preview/figma-capture-clinical-skills.mjs nn-clinical-skills-lesson-mint-2026 lesson mint-blossom --mobile
 */
...
if (!captureId) {
  console.error(
    "usage: node figma-capture-clinical-skills.mjs <captureId> [hub|lesson] [theme] [--mobile]",
  );
  process.exit(1);
}

const paths = {
  hub: "/app/clinical-skills",
  lesson: "/app/clinical-skills/foley-catheter-insertion-female",
};
const path = paths[surface] ?? paths.hub;
const url = `http://127.0.0.1:3000${path}`;
const viewport = mobile ? { width: 390, height: 844 } : { width: 1440, height: 900 };
const selector = "[data-nn-clinical-skills-workstation]";
