...
const explicitPathwayId = process.env.LEARNING_ROUTES_E2E_PATHWAY_ID?.trim();
const pathwayIds = explicitPathwayId
  ? [explicitPathwayId]
  : ([PAID_E2E_DEFAULT_PATHWAY_ID, "ca-rn-nclex-rn"] as const);
