---
slug: au-np-acp-ckd-proteinuria-bp-targets-educational-primary-care-australia
title: "Chronic kidney disease staging, proteinuria, and BP targets (study overview) in primary care across Australia: educational overview"
...
category: Nephrology
tags: ["Australia","Nurse Practitioner","CKD","Proteinuria","BP","primary care australia"]
...
canonicalUrl: /blog/au-np-acp-ckd-proteinuria-bp-targets-educational-primary-care-australia
...
<h2>Introduction</h2>
<p>This guide is written in clear international English for Australian nurse practitioner candidates and advanced practice nurses preparing for registration, endorsement study, and clinically weighted exams. It connects Chronic kidney disease staging, proteinuria, and BP targets (study overview) to primary care across Australia. The framing is educational: it supports learning, clinical reasoning, and workplace orientation—not individualized legal, regulatory, or medical advice. Always verify requirements with AHPRA, the Nursing and Midwifery Board of Australia (NMBA), your education provider, and your employer.</p>
...
<ul>
  ...
  <li><strong>Mechanism-first reasoning</strong>: connect Chronic kidney disease staging, proteinuria, and BP targets (study overview) to assessment changes before choosing interventions, then check whether your answer fits primary care across Australia access realities.</li>
