 ...
 */
import { listBlogStaticLongtailFileRecords } from "@/lib/blog/blog-static-longtail-load";
import { validateAllBlogStaticLongtailRecords } from "@/lib/blog/blog-static-longtail-validate";

const records = listBlogStaticLongtailFileRecords().map(({ file, record }) => ({ file, record }));
