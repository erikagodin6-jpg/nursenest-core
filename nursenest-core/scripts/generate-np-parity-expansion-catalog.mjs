...
const systems = [
  {
    ...
    concepts: [
      ...
      "dyslipidemia risk stratification and statin therapy",
  ...
  },
  {
    ...
    concepts: [
      ...
      "acute otitis media adult evaluation and treatment",
      "conjunctivitis evaluation and management",
      "glaucoma recognition and urgent referral",
      "red eye differential diagnosis and urgent ophthalmology referral",
      "epistaxis management and anticoagulation considerations",
      "benign paroxysmal positional vertigo diagnosis and repositioning maneuvers",
      "hearing loss evaluation and audiology referral",
    ],
  },
  {
    system: "Neurological",
    ...
    concepts: [
      ...
      "restless legs syndrome evaluation and treatment",
  ...
  },
  {
    ...
    concepts: [
      ...
      "tinea corporis and tinea pedis diagnosis and treatment",
      "scabies diagnosis and household eradication",
      "common warts treatment and recurrence counseling",
      "herpes simplex outpatient management",
