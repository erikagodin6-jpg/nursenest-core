#!/usr/bin/env npx tsx
/**
 * Idempotent seed: upserts 20 premium-flagged branching scenarios (5 clinical domains × 4 tiers).
 * Match key: title prefix [seed:real-v1-<tier>-<slug>].
 *
 * Usage (from nursenest-core/): npx tsx scripts/seed-clinical-scenarios-real-runner.mts
 * Or: npm run seed:clinical-scenarios-real
 * Requires DATABASE_URL.
 */
import "../src/lib/db/script-env-bootstrap";

import { Prisma } from "@prisma/client";
import { realTwentyPremiumSpecs } from "../src/lib/clinical-scenarios/real-clinical-scenarios-twenty";
import {
...
async function main() {
  ...
  console.log(`Real premium clinical scenarios: created=${created}, updated=${updated}, total processed=${specs.length}`);
}
