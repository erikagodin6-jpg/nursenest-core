  ...
  projects: [
    ...
    },
    {
      ...
      testIgnore: [
        ...
        /paid-user-(00-fast-sanity|dashboard-shell-first|dashboard-fail-soft|degraded-mode|data-load|performance|stress|login-flow|journey|entitlements|navigation|i18n|api-health|session-persistence|key-pages-performance|visual-regression|adaptive-question-flow|mobile|cat-smoke|duplicate-heavy-requests)\.spec\.ts$/,
