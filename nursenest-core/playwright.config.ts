...
const CHROMIUM_PAID_SPEC_MATCH =
  /paid-user-(00-fast-sanity|dashboard-shell-first|degraded-mode|data-load|performance|stress|login-flow|journey|entitlements|navigation|i18n|api-health|session-persistence|key-pages-performance|visual-regression|adaptive-question-flow|mobile|cat-smoke|duplicate-heavy-requests)\.spec\.ts$|paid-subscriber-audit\.spec\.ts$|production-i18n-bundle\.spec\.ts$/;
  ...
  projects: [
    ...
    },
    {
      ...
      testIgnore: [
        ...
        /paid-user-(00-fast-sanity|dashboard-shell-first|degraded-mode|data-load|performance|stress|login-flow|journey|entitlements|navigation|i18n|api-health|session-persistence|key-pages-performance|visual-regression|adaptive-question-flow|mobile|cat-smoke|duplicate-heavy-requests)\.spec\.ts$/,
