...
import { joinSocialGroupByCode } from "@/lib/social-study/social-study-service";
...
export async function POST(req: Request) {
  return runWithApiTelemetry(req, "POST /api/learner/social/groups/join", "content", async () => {
    ...
    const result = await joinSocialGroupByCode(socialDb, gate.userId, parsed.data.code);
