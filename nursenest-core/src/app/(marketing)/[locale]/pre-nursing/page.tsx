        ...
        <section className="mt-10 grid gap-8 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-muted">
              When you&apos;re ready, NurseNest offers paid exam pathways with full question banks, mocks, and lessons
              aligned to NCLEX-RN, practical nursing (NCLEX-PN in the US or REx-PN in Canada), and NP tracks.
            </p>
