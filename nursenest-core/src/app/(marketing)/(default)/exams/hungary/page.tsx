...
const HUNGARY_METADATA_KEYS = ["exams.hungary.metaTitle", "exams.hungary.metaDescription"] as const;

export async function generateMetadata(): Promise<Metadata> {
  const messages = await loadMarketingMetadataMessages(DEFAULT_MARKETING_LOCALE, HUNGARY_METADATA_KEYS);
  const title =
