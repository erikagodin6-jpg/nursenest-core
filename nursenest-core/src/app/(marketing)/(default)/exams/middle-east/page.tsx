...
const MIDDLE_EAST_METADATA_KEYS = ["exams.middleEast.metaTitle", "exams.middleEast.metaDescription"] as const;

export async function generateMetadata(): Promise<Metadata> {
  const messages = await loadMarketingMetadataMessages(DEFAULT_MARKETING_LOCALE, MIDDLE_EAST_METADATA_KEYS);
  const title =
