...
const ITALY_METADATA_KEYS = ["exams.italy.metaTitle", "exams.italy.metaDescription"] as const;

export async function generateMetadata(): Promise<Metadata> {
  const messages = await loadMarketingMetadataMessages(DEFAULT_MARKETING_LOCALE, ITALY_METADATA_KEYS);
  const title =
