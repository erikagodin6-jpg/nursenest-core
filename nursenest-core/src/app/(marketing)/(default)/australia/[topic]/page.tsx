...
import {
  AUSTRALIA_TOPIC_SLUGS,
  AustraliaTopicView,
  parseAustraliaTopicParam,
} from "@/components/marketing/exams-australia/australia-topic-view";
...
export function generateStaticParams() {
  return AUSTRALIA_TOPIC_SLUGS.map((topic) => ({ topic }));
}
