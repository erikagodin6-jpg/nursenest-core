    ...
    structuredData: [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Arterial Line Interpretation", item: `${SITE_ORIGIN}${PATH}` },
        ],
      },
    ],
  });
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
        ...
        <span>/</span>
        <span className="text-gray-900 font-medium">Arterial Line Interpretation</span>
      </nav>
