...
export function generateMetadata() {
  return generateMarketingCountryHubMetadata("canada");
}

export default function CanadaMarketingHubPage() {
  return <CountryMarketingHome country="canada" content={getCountryHomepageContent("canada")} />;
}
