    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          <h2 className="mb-2 nn-marketing-h2" data-testid="text-global-coverage-heading">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:gap-8">
          <div className="rounded-2xl border border-border bg-card p-6 shadow-[var(--shadow-card)] lg:p-8" data-testid="panel-countries">
            <div className="mb-5 flex items-center gap-3">
              ...
              <h3 className="nn-marketing-h3">{t("components.heroGlobalCoverage.supportedCountries")}</h3>
            </div>
            <div className="grid grid-cols-2 gap-3">
              {SUPPORTED_COUNTRIES.map((country) => (
                ...
                >
                  ...
                  <span className="nn-marketing-body-sm text-muted-foreground">{country.name}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-[var(--shadow-card)] lg:p-8" data-testid="panel-languages">
            <div className="mb-5 flex items-center gap-3">
              ...
              <h3 className="nn-marketing-h3">{t("components.heroGlobalCoverage.supportedLanguages")}</h3>
            </div>
            ...
            <Link
              ...
              className={`${MARKETING_TERTIARY_LINK_CLASS} mt-5 gap-1.5 px-0 no-underline hover:underline`}
