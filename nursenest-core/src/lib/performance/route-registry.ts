...
export const ROUTE_PERFORMANCE_REGISTRY: readonly RouteBudget[] = [
  ...
  },
  {
    ...
    maxQueryCount: 18,
    ciEnforced: true,
    notes: "ECG must shell-first load under the platform activity budget; media should stream after shell.",
  },
  {
    id: "learner-cat",
  ...
  },
  {
    ...
    maxQueryCount: 22,
    ciEnforced: true,
    notes: "LOFT/OSCE launch must shell-first load; station catalogs should come from cache/snapshot or bounded DB reads.",
  },
  {
