 ...
 * `/public/logos/{theme}-brandlogo.png`, plus CSS-extracted palette colors.
 *
 * PNG assets are produced from the canonical transparent NurseNest logo and
 * recolored per theme using the darkest palette color to preserve contrast.
 *
 * `logoColor` is the exact darkest palette hex used for that theme logo PNG.
 */
