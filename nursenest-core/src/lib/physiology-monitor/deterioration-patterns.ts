...
export const DETERIORATION_PATTERNS: DeteriorationPattern[] = [
  ...
  // ── 22. Septic Shock ─────────────────────────────────────────────────────────
  {
    ...
    label: "Septic Shock",
    category: "infectious",
    description: "Vasopressor-dependent distributive shock from overwhelming infection with refractory hypotension and multiorgan failure.",
    initialOverrides: {
      heartRate: 132, systolicBP: 74, diastolicBP: 36, map: 49,
      respiratoryRate: 32, spo2: 88, temperature: 39.6,
      lactate: 6.4, urineOutputPerHour: 6, cvp: 2, gcs: 11,
      cardiacOutput: 7.8,
      ecgRhythmKey: "sinus_tachycardia",
    },
    stages: {
      early: {
        durationTicks: 3,
        vitalDeltas: { heartRate: 3, systolicBP: -3, respiratoryRate: 2, spo2: -1.5, lactate: 0.5, urineOutputPerHour: -2, gcs: -0.5 },
        ecgRhythmKey: "sinus_tachycardia",
        ecgFeatures: {},
        ecgQrsWidth: 0.09,
        explanation: "Vasopressor-dependent shock: norepinephrine escalating. Persistent hyperlactatemia despite initial fluid resuscitation. Source control required urgently.",
      },
      developing: {
        durationTicks: 3,
        vitalDeltas: { heartRate: 2, systolicBP: -4, spo2: -1.5, lactate: 0.5, urineOutputPerHour: -2, gcs: -0.5, cardiacOutput: -0.4 },
        ecgRhythmKey: "sinus_tachycardia",
        ecgFeatures: {},
        ecgQrsWidth: 0.09,
        explanation: "Myocardial depression from sepsis-induced cardiomyopathy. Vasopressin added as second vasopressor. Hydrocortisone 200 mg/day for refractory shock.",
      },
      severe: {
        durationTicks: 3,
        vitalDeltas: { heartRate: 2, systolicBP: -4, spo2: -1.5, lactate: 0.4, urineOutputPerHour: -2, gcs: -1, cardiacOutput: -0.25 },
        ecgRhythmKey: "atrial_fibrillation",
        ecgFeatures: {},
        ecgQrsWidth: 0.09,
        explanation: "MODS: AKI (anuria), DIC, hepatic failure. CRRT initiated. Prone positioning for ARDS. Mortality exceeds 40% with four-organ failure.",
      },
      critical: {
        durationTicks: 5,
        vitalDeltas: { heartRate: 1.5, systolicBP: -3, spo2: -1, lactate: 0.3, gcs: -0.5, cardiacOutput: -0.15, urineOutputPerHour: -1 },
        ecgRhythmKey: "atrial_fibrillation",
        ecgFeatures: {},
        ecgQrsWidth: 0.10,
        explanation: "Refractory septic shock with five-organ failure. Goals-of-care conversation mandatory. SOFA > 15: 80% mortality without ECMO consideration.",
      },
    },
    tags: ["septic-shock", "sepsis", "vasopressor", "icu", "mods"],
  },

  // ── 23. Acute Pulmonary Edema ─────────────────────────────────────────────────
  {
    key: "pulmonary_edema",
    label: "Flash Pulmonary Edema",
    category: "cardiac",
    description: "Sudden acute LV failure with alveolar flooding, pink frothy sputum, and rapidly worsening hypoxemia.",
    initialOverrides: {
      heartRate: 122, systolicBP: 192, diastolicBP: 114, map: 140,
      respiratoryRate: 36, spo2: 80, etco2: 24, cvp: 20,
      cardiacOutput: 3.2,
      ecgRhythmKey: "sinus_tachycardia",
      ecgFeatures: { stDepression: true },
      ecgQrsWidth: 0.09,
    ...
    stages: {
      early: {
        durationTicks: 3,
        vitalDeltas: { heartRate: 5, respiratoryRate: 3, spo2: -4, systolicBP: -5, cvp: 2, cardiacOutput: -0.35 },
        ecgRhythmKey: "sinus_tachycardia",
        ecgFeatures: { stDepression: true },
        ecgQrsWidth: 0.09,
        explanation: "Flash pulmonary edema: high-flow O₂ or NIV immediately. Nitroglycerin IV reduces preload (avoid if SBP < 90). Furosemide IV for volume overload component. Upright position.",
      },
      developing: {
        durationTicks: 3,
        vitalDeltas: { heartRate: 4, respiratoryRate: 2, spo2: -3, systolicBP: -5, cvp: 1.5, cardiacOutput: -0.3 },
        ecgRhythmKey: "sinus_tachycardia",
        ecgFeatures: { stDepression: true },
        ecgQrsWidth: 0.09,
        explanation: "BiPAP/CPAP reduces preload and work of breathing. SpO₂ < 88% despite NIV requires intubation. Avoid succinylcholine if hyperkalemia suspected. Ketamine preferred induction.",
      },
      severe: {
        durationTicks: 3,
        vitalDeltas: { heartRate: 3, respiratoryRate: 1.5, spo2: -3, systolicBP: -5, cvp: 1, cardiacOutput: -0.25, gcs: -0.5 },
        ecgRhythmKey: "atrial_fibrillation",
        ecgFeatures: { stDepression: true },
        ecgQrsWidth: 0.10,
        explanation: "Intubation required. Lung-protective ventilation: 6 mL/kg IBW, PEEP 8–10. Post-intubation hypotension from decreased preload — vasopressor ready.",
      },
      critical: {
        durationTicks: 4,
        vitalDeltas: { heartRate: 2, spo2: -2, cardiacOutput: -0.2, gcs: -1, systolicBP: -5, urineOutputPerHour: -5 },
        ecgRhythmKey: "ventricular_tachycardia",
        ecgFeatures: { stDepression: true },
        ecgQrsWidth: 0.14,
        explanation: "Cardiogenic shock with refractory pulmonary edema. Impella/ECMO consideration. Emergent cath lab if ACS is the precipitant. Mortality > 50% without mechanical support.",
      },
    },
    tags: ["pulmonary-edema", "flash-pe", "cardiac", "icu", "emergency"],
  },

  // ── 24. ACS Differential (NP) ────────────────────────────────────────────────
  {
    key: "acs_differential",
    label: "ACS Differential Diagnosis",
    category: "cardiac",
    description: "NP-level ACS diagnostic reasoning: STEMI vs NSTEMI vs unstable angina vs non-cardiac causes with evolving ECG changes.",
    initialOverrides: {
      heartRate: 94, systolicBP: 162, diastolicBP: 96, map: 118,
      respiratoryRate: 18, spo2: 96, painScore: 7, temperature: 37.2,
      ecgRhythmKey: "sinus_rhythm",
      ecgFeatures: { stDepression: true },
      ecgQrsWidth: 0.09,
    },
    stages: {
      early: {
        durationTicks: 4,
        vitalDeltas: { heartRate: 3, systolicBP: -3, spo2: -0.5, painScore: 0.5 },
        ecgRhythmKey: "sinus_rhythm",
        ecgFeatures: { stDepression: true },
        ecgQrsWidth: 0.09,
        explanation: "High-sensitivity troponin pending. ST depression V4–V6 suggests posterior or lateral ischemia. Aspirin 325 mg, nitrates if BP permits. Serial ECGs q15 min. Avoid morphine.",
      },
      developing: {
        durationTicks: 3,
        vitalDeltas: { heartRate: 4, systolicBP: -5, diastolicBP: -2, spo2: -1, painScore: 0.5, cardiacOutput: -0.2 },
        ecgRhythmKey: "sinus_tachycardia",
        ecgFeatures: { stDepression: true },
        ecgQrsWidth: 0.10,
        explanation: "NSTEMI confirmed: rising troponin + dynamic ECG changes. Anticoagulation (heparin or LMWH). P2Y₁₂ inhibitor (ticagrelor). Cardiology for urgent angiography within 24 h.",
      },
      severe: {
        durationTicks: 3,
        vitalDeltas: { heartRate: 4, systolicBP: -7, diastolicBP: -3, spo2: -1.5, cardiacOutput: -0.3, map: -5 },
        ecgRhythmKey: "sinus_tachycardia",
        ecgFeatures: { stDepression: true, widenedQrs: true },
        ecgQrsWidth: 0.11,
        explanation: "Cardiogenic shock from high-risk NSTEMI (e.g. left main). Emergent PCI regardless of time from onset. IABP or Impella. Avoid thrombolytics in NSTEMI.",
      },
      critical: {
        durationTicks: 4,
        vitalDeltas: { heartRate: 3, systolicBP: -5, spo2: -1.5, cardiacOutput: -0.25, gcs: -0.5 },
        ecgRhythmKey: "ventricular_tachycardia",
        ecgFeatures: { avDissociation: true },
        ecgQrsWidth: 0.14,
        explanation: "Malignant VT from ischemia — treated with synchronized cardioversion (if pulse present) or unsynchronized defibrillation (if pulseless). Emergent revascularization.",
      },
    },
    tags: ["acs", "nstemi", "chest-pain", "np", "differential", "cardiac"],
  },

  // ── 25. Undifferentiated Shock (NP) ──────────────────────────────────────────
  {
    key: "complex_shock",
    label: "Undifferentiated Shock",
    category: "systemic",
    description: "NP-level shock management requiring rapid differentiation of distributive, cardiogenic, hypovolemic, and obstructive etiologies.",
    initialOverrides: {
      heartRate: 126, systolicBP: 80, diastolicBP: 42, map: 55,
      respiratoryRate: 28, spo2: 91, temperature: 38.4,
      lactate: 4.2, cvp: 4, cardiacOutput: 5.6,
      urineOutputPerHour: 14, gcs: 13,
      ecgRhythmKey: "sinus_tachycardia",
    },
    stages: {
      early: {
        durationTicks: 3,
        vitalDeltas: { heartRate: 4, systolicBP: -4, spo2: -1, lactate: 0.4, urineOutputPerHour: -3 },
        ecgRhythmKey: "sinus_tachycardia",
        ecgFeatures: {},
        ecgQrsWidth: 0.09,
        explanation: "Shock workup: immediate 30 mL/kg crystalloid bolus + reassess. Bedside echo (LV function, IVC collapsibility, pericardial effusion). ScvO₂, central venous access. Broad-spectrum antibiotics empirically.",
      },
      developing: {
        durationTicks: 3,
        vitalDeltas: { heartRate: 4, systolicBP: -5, diastolicBP: -2, spo2: -1.5, lactate: 0.5, urineOutputPerHour: -3, gcs: -0.5 },
        ecgRhythmKey: "sinus_tachycardia",
        ecgFeatures: {},
        ecgQrsWidth: 0.09,
        explanation: "Fluid-unresponsive shock: MAP < 65 despite 2 L → norepinephrine. Differentiate by echo: hyperdynamic LV = distributive; hypokinetic LV = cardiogenic; plethoric IVC = obstructive.",
      },
      severe: {
        durationTicks: 3,
        vitalDeltas: { heartRate: 3, systolicBP: -5, spo2: -1.5, lactate: 0.5, gcs: -1, cardiacOutput: -0.3, urineOutputPerHour: -2 },
        ecgRhythmKey: "sinus_tachycardia",
        ecgFeatures: { stDepression: true },
        ecgQrsWidth: 0.10,
        explanation: "Escalating vasopressors: add vasopressin. Emerging organ failure. Pericardiocentesis if tamponade on echo. Needle decompression if tension pneumothorax. Source control for sepsis.",
      },
      critical: {
        durationTicks: 4,
        vitalDeltas: { heartRate: 2, systolicBP: -4, spo2: -1.5, lactate: 0.4, gcs: -1.5, cardiacOutput: -0.2, urineOutputPerHour: -1.5 },
        ecgRhythmKey: "atrial_fibrillation",
        ecgFeatures: {},
        ecgQrsWidth: 0.10,
        explanation: "Refractory shock: five-organ failure trajectory. ECMO-eligible criteria assessment. Goals-of-care discussion. Mortality > 60% with maximum vasoactive support.",
      },
    },
    tags: ["shock", "undifferentiated", "np", "icu", "emergency", "differential"],
  },

  // ── 26. Multi-System Organ Failure (NP) ──────────────────────────────────────
  {
    key: "multi_system_failure",
    label: "Multi-System Organ Failure",
    category: "systemic",
    description: "Sequential organ failure from prolonged shock — cardiac, respiratory, renal, hepatic, and coagulation failure requiring NP-level prognostic reasoning.",
    initialOverrides: {
      heartRate: 116, systolicBP: 82, diastolicBP: 44, map: 57,
      respiratoryRate: 30, spo2: 86, etco2: 30,
      temperature: 36.8, lactate: 7.2, gcs: 8,
      isVentilated: true, peep: 12, tidalVolume: 400,
      peakInspiratoryPressure: 46, plateauPressure: 38, lungCompliance: 24,
      cvp: 16, cardiacOutput: 3.0, urineOutputPerHour: 4,
      ecgRhythmKey: "atrial_fibrillation",
    },
    stages: {
      early: {
        durationTicks: 4,
        vitalDeltas: { heartRate: 2.5, systolicBP: -3, spo2: -1.5, lactate: 0.3, gcs: -0.5, urineOutputPerHour: -1.5, lungCompliance: -1.5, cardiacOutput: -0.15 },
        ecgRhythmKey: "atrial_fibrillation",
        ecgFeatures: {},
        ecgQrsWidth: 0.10,
        explanation: "SOFA 10–12: three-organ failure. CRRT for AKI. Prone positioning (PaO₂/FiO₂ < 150). Corticosteroids for refractory vasoplegia. DIC management with FFP/cryoprecipitate.",
      },
      developing: {
        durationTicks: 4,
        vitalDeltas: { heartRate: 2, systolicBP: -3.5, spo2: -1, lactate: 0.3, gcs: -1, urineOutputPerHour: -1, lungCompliance: -1, cardiacOutput: -0.12 },
        ecgRhythmKey: "atrial_fibrillation",
        ecgFeatures: { stDepression: true },
        ecgQrsWidth: 0.11,
        explanation: "SOFA 13–14: four-organ failure. Consider ECMO if reversible underlying cause (e.g. post-viral myocarditis). Family conference: realistically frame prognosis. Palliative integration.",
      },
      severe: {
        durationTicks: 4,
        vitalDeltas: { heartRate: 1.5, systolicBP: -3, spo2: -1, lactate: 0.2, gcs: -0.5, cardiacOutput: -0.1, urineOutputPerHour: -0.5 },
        ecgRhythmKey: "atrial_fibrillation",
        ecgFeatures: { stDepression: true },
        ecgQrsWidth: 0.11,
        explanation: "SOFA > 15: five-organ failure, 80% mortality. Document prognosis clearly in the chart. Support family in decision-making. Comfort-focused goals if appropriate.",
      },
      critical: {
        durationTicks: 6,
        vitalDeltas: { heartRate: 1, systolicBP: -2, spo2: -0.5, lactate: 0.1, gcs: -0.5, cardiacOutput: -0.08 },
        ecgRhythmKey: "atrial_fibrillation",
        ecgFeatures: { stDepression: true },
        ecgQrsWidth: 0.12,
        explanation: "Terminal organ failure. If goals shift to comfort: discontinue vasopressors, CRRT, vent support. Symptom-focused care. Presence and dignity at end of life.",
      },
    },
    tags: ["mods", "multiorgan-failure", "np", "icu", "critical-care", "palliative"],
  },
