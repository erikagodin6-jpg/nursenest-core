...
const CONDITION_PROFILES: ConditionClinicalProfile[] = [
  ...
  // ── New conditions Phase 3 ────────────────────────────────────────────────────
  {
    conditionKey: "opioid_toxicity",
    expectedCues: ["respiratory depression", "low respiratory rate", "miosis", "altered LOC", "rising EtCO₂"],
    expectedEcgFindings: ["sinus bradycardia"],
    optimalInterventionSequence: ["supplemental_o2", "naloxone"],
    contraindicatedInterventions: [],
    criticalWindowTicks: 4,
    escalationRequired: true,
    reassessmentExpected: true,
  ...
  {
    conditionKey: "stroke",
    expectedCues: ["hypertension", "falling GCS", "focal deficit", "atrial fibrillation", "rising ICP"],
    expectedEcgFindings: ["atrial fibrillation", "sinus bradycardia"],
    optimalInterventionSequence: ["supplemental_o2", "mannitol"],
    contraindicatedInterventions: ["aggressive_antihypertensive"],
    criticalWindowTicks: 8,
    escalationRequired: true,
    reassessmentExpected: true,
  },
  {
    ...
    expectedCues: ["refractory hypotension", "vasopressor requirement", "hyperlactatemia", "oliguria", "organ failure"],
    expectedEcgFindings: ["sinus tachycardia", "atrial fibrillation"],
    optimalInterventionSequence: ["norepinephrine", "fluid_bolus", "supplemental_o2"],
    contraindicatedInterventions: ["furosemide"],
    criticalWindowTicks: 5,
    escalationRequired: true,
    reassessmentExpected: true,
  },
  {
    conditionKey: "pulmonary_edema",
    expectedCues: ["severe hypoxemia", "pink frothy sputum", "bilateral crackles", "hypertension", "elevated CVP"],
    expectedEcgFindings: ["sinus tachycardia", "ST depression"],
    optimalInterventionSequence: ["bipap", "furosemide", "nitroglycerin", "supplemental_o2"],
    contraindicatedInterventions: ["fluid_bolus"],
    criticalWindowTicks: 5,
    escalationRequired: true,
    reassessmentExpected: true,
  ...
  {
    conditionKey: "acs_differential",
    expectedCues: ["ST depression", "chest pain", "dynamic ECG changes", "rising troponin", "hemodynamic instability"],
    expectedEcgFindings: ["ST depression", "sinus tachycardia", "ventricular tachycardia"],
    optimalInterventionSequence: ["supplemental_o2", "amiodarone", "defibrillation"],
    contraindicatedInterventions: [],
    criticalWindowTicks: 6,
    escalationRequired: true,
  ...
  },
  {
    ...
    expectedCues: ["hypotension", "tachycardia", "hyperlactatemia", "oliguria", "cold extremities"],
    expectedEcgFindings: ["sinus tachycardia"],
    optimalInterventionSequence: ["fluid_bolus", "norepinephrine", "supplemental_o2"],
    contraindicatedInterventions: [],
    criticalWindowTicks: 5,
    escalationRequired: true,
    reassessmentExpected: true,
  },
  {
    ...
    expectedCues: ["multiorgan failure", "refractory hypotension", "severe hypoxemia", "anuria", "falling GCS"],
    expectedEcgFindings: ["atrial fibrillation", "ST depression"],
    optimalInterventionSequence: ["norepinephrine", "increase_peep"],
    contraindicatedInterventions: [],
    criticalWindowTicks: 6,
    escalationRequired: true,
    reassessmentExpected: true,
  },
  {
    ...
    expectedCues: ["rising PIP", "air trapping waveform", "hemodynamic collapse", "incomplete expiration"],
    expectedEcgFindings: ["sinus tachycardia", "pulseless electrical activity"],
    optimalInterventionSequence: ["vent_disconnect", "reduce_respiratory_rate"],
    contraindicatedInterventions: ["increase_peep"],
    criticalWindowTicks: 5,
    escalationRequired: true,
    reassessmentExpected: true,
  },
  {
    conditionKey: "rt_mucus_plug",
    expectedCues: ["sudden PIP rise", "falling SpO₂", "absent breath sounds", "reduced VT delivery"],
    expectedEcgFindings: ["sinus tachycardia"],
    optimalInterventionSequence: ["supplemental_o2", "suction"],
    contraindicatedInterventions: [],
    criticalWindowTicks: 4,
    escalationRequired: true,
    reassessmentExpected: true,
  },
  {
    ...
    expectedCues: ["double triggering", "high tidal volumes", "patient agitation", "waveform dips"],
    expectedEcgFindings: ["sinus tachycardia"],
    optimalInterventionSequence: ["mode_change", "sedation_adjustment"],
    contraindicatedInterventions: [],
    criticalWindowTicks: 8,
  ...
  },
  {
    ...
    expectedCues: ["absent EtCO₂", "falling SpO₂", "loss of VT", "patient distress"],
    expectedEcgFindings: ["sinus tachycardia", "sinus bradycardia"],
    optimalInterventionSequence: ["supplemental_o2", "manual_ventilation", "reintubation"],
    contraindicatedInterventions: [],
    criticalWindowTicks: 3,
    escalationRequired: true,
    reassessmentExpected: true,
