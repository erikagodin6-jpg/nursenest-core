...
export const CARDIAC_SOUND_RECORDS: CardiacSoundRecord[] = [
  ...
  },
  {
    ...
    name: "Clicks",
    category: "abnormal",
    timing: "Usually systolic; timing varies by mechanism",
    pitchQuality: "Sharp, high-frequency extra sound",
    description: "Brief extra cardiac sound classically used in teaching for ejection clicks or midsystolic clicks.",
    auscultationSite: "Depends on suspected valve; apex for mitral valve prolapse teaching, base for ejection click teaching",
    clinicalSignificance: "Exam stems use clicks to cue valve mobility, prolapse, or congenital valve patterns when paired with murmur timing.",
    commonCauses: ["Mitral valve prolapse", "Bicuspid aortic valve", "Pulmonic valve disease"],
    waveformType: "systolic-ejection",
    allowedTiers: CARDIAC_ADVANCED_MURMUR_TIERS,
    clinicalPearl: "A click alone is not the diagnosis; pair it with timing, location, radiation, symptoms, and the associated murmur.",
  },
  {
    id: "opening-snap",
    name: "Opening snap",
    category: "abnormal",
    timing: "Early diastole after S2",
    pitchQuality: "Sharp, high-pitched snap followed by diastolic rumble in classic teaching",
    description: "Sound of a stenotic but mobile mitral valve opening; commonly taught with rheumatic mitral stenosis patterns.",
    auscultationSite: "Apex and lower left sternal border with bell/diaphragm comparison",
    clinicalSignificance: "Supports mitral stenosis when paired with exertional dyspnea, AF risk, left atrial enlargement, or rheumatic history.",
    commonCauses: ["Mitral stenosis", "Rheumatic valve disease teaching pattern"],
    waveformType: "diastolic-rumble",
    allowedTiers: CARDIAC_ADVANCED_MURMUR_TIERS,
    clinicalPearl: "An opening snap is an early diastolic clue; do not confuse it with S3, which reflects rapid ventricular filling.",
  },
  {
