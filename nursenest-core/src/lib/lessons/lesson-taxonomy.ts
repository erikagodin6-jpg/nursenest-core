...
const LEGACY_TOPIC_TO_CATEGORY: Record<string, LessonCategory> = {
  ...
  "Infection Control (PN)": "Infection & Sepsis",
  ...
  "Sepsis & infection control": "Infection & Sepsis",
...
const TITLE_HINT_RULES: ReadonlyArray<{ re: RegExp; category: LessonCategory }> = [
  ...
  { re: /\b(aki\b|ckd\b|dialysis|renal|urinary|uti\b|pyeloneph|creatinine|catheter.?associated|urine output|kidney)\b/i, category: "Renal & GU" },
  ...
  { re: /\b(sepsis|infection control|isolation|hiv\b|pep\b|clabsi|central line|culture|ppe\b|wound infection)\b/i, category: "Infection & Sepsis" },
...
export const RN_PN_RPN_HUB_CATEGORY_DEFS: readonly RnPnRpnHubCategoryDef[] = [
  ...
  { id: "renal_urinary", hubDisplayTitle: "Renal & GU", description: "Kidney function, fluid balance, urinary disorders, and urinary care." },
