...
function examNamesForContextExam(exam: string): string[] {
  if (exam === "NCLEX_RN" || exam === "NCLEX-RN") return ["NCLEX-RN", "RN-CAT", "NCLEX"];
  if (exam === "NCLEX_PN" || exam === "NCLEX-PN") return ["NCLEX-PN", "RPN-CAT", "NCLEX"];
  if (exam === "REX_PN" || exam === "REX-PN" || exam === "REx-PN") return ["REx-PN", "REX-PN", "RPN-CAT"];
