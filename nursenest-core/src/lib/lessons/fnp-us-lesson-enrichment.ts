...
const SLUG_PRIMARY: Partial<Record<string, FnpLifespanGroup>> = {
  ...
  "np-contraception-counseling-selection-gold": "prenatal_womens",
  "np-reproductive-screening-prevention-gold": "prenatal_womens",
  "np-ambulatory-gynec-common-presentations-gold": "prenatal_womens",
  "np-pediatric-well-child-prevention-gold": "pediatric",
  "np-immunization-vaccines-primary-care-gold": "lifespan_mixed",
  "np-travel-medicine-pretravel-gold": "lifespan_mixed",
  "np-msk-rheumatology-outpatient-gold": "adult",
  "np-antiinfectives-stewardship-outpatient-gold": "adult",
  ...
  "np-geriatrics-polypharmacy-deprescribing-gold": "geriatric",
  "np-heart-failure-primary-care-gold": "adult",
  "np-asthma-outpatient-gold": "adult",
  "np-pneumonia-cap-outpatient-gold": "adult",
  "np-type2-diabetes-outpatient-gold": "adult",
  "np-thyroid-primary-care-gold": "adult",
  "np-obesity-metabolic-management-gold": "adult",
};
