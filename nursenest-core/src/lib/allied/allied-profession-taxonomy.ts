...
export const ALLIED_PROFESSION_TAXONOMIES: Record<string, AlliedProfessionTaxonomyCategory[]> = {
  ...
  /** Eleven RT pillar categories — stable slugs where possible; labels aligned to tier readiness docs. */
  respiratory: [
    cat("airway-clearance", "Airway management", "Airway adjuncts, secretion management, and escalation cues for RT certification prep."),
    cat("oxygen-therapy", "Oxygen therapy", "Devices, flows, humidification, titration, and safety sequencing for respiratory exams."),
    cat("ventilation", "Mechanical ventilation", "Modes, alarms, equipment checks, weaning judgment, and instability escalation for RRT items."),
    cat("abgs", "ABGs", "Interpretation drills, compensation patterns, oxygenation indices, and clinical correlation."),
    cat("pulmonary-diagnostics", "Pulmonary diagnostics", "PFT patterns, bedside spirometry support, imaging correlation, and quality basics."),
    cat("pulmonary-pharmacology", "Pulmonary pharmacology", "Bronchodilators, steroids, pulmonary vasodilators, and aerosol delivery at RT exam depth."),
    cat("neonatal-pediatric-respiratory", "Neonatal / pediatric respiratory care", "NICU/PICU language, oxygen targets, and escalation appropriate to pediatric RT preparation."),
    cat("critical-care-rt", "Critical care", "Shock, multisystem deterioration, hemodynamics context, and ICU respiratory priorities."),
    cat("emergency-respiratory", "Emergency respiratory care", "Rapid assessment, prehospital overlap, RSI awareness, and crisis airway framing."),
    cat("infectious-pulmonary", "Infection control / safety", "Isolation, PPE, transmission precautions, and respiratory outbreak basics."),
    cat("ethics-escalation-rt", "Ethics / documentation", "Goals-of-care communication, scope boundaries, consent, and defensible charting."),
  ],
  paramedic: [
...
const TOPIC_TO_TAXONOMY: Record<string, Record<string, { primary: string; secondaries?: string[] }>> = {
  ...
  respiratory: {
    ...
    "vital-signs": { primary: "oxygen-therapy", secondaries: ["critical-care-rt"] },
    "emergency-response": { primary: "emergency-respiratory", secondaries: ["ventilation"] },
    "infection-control": { primary: "infectious-pulmonary", secondaries: ["neonatal-pediatric-respiratory"] },
    "human-physiology": { primary: "pulmonary-pharmacology", secondaries: ["abgs"] },
  },
  "social-work": {
