...
export const HEMODYNAMICS_FUNDAMENTALS_ENTITLEMENT =
  "hemodynamics_fundamentals" as const;

export const ADVANCED_HEMODYNAMICS_ENTITLEMENT =
  "advanced_hemodynamics_paid" as const;
...
export const HEMODYNAMICS_MODULE_ROUTE =
  "/modules/hemodynamics" as const;

export const ADVANCED_HEMODYNAMICS_MODULE_ROUTE =
  "/modules/hemodynamics-advanced" as const;

export const ADVANCED_HEMODYNAMICS_MODULE_CHECKOUT_ANCHOR =
  `${ADVANCED_HEMODYNAMICS_MODULE_ROUTE}#upgrade`;

export const ADVANCED_HEMODYNAMICS_PRICING_ANCHOR =
  "/pricing#advanced-hemodynamics-add-on" as const;

// ─── Tier eligibility ──────────────────────────────────────────────────────────

/** RN and NP subscribers get Hemodynamic Monitoring Fundamentals included. */
export const HEMODYNAMICS_FUNDAMENTALS_ALLOWED_TIERS =
  ["RN", "NP"] as const satisfies readonly TierCode[];

/** Advanced Hemodynamics (paid add-on) requires RN or NP base subscription. */
export const ADVANCED_HEMODYNAMICS_ALLOWED_TIERS =
  ["RN", "NP"] as const satisfies readonly TierCode[];

export type AdvancedHemodynamicsAllowedTier =
  (typeof ADVANCED_HEMODYNAMICS_ALLOWED_TIERS)[number];

// ─── Plan codes ────────────────────────────────────────────────────────────────

/** One-time purchase — plan code carries no duration suffix. */
export const ADVANCED_HEMODYNAMICS_PLAN_CODE =
  ADVANCED_HEMODYNAMICS_ENTITLEMENT;

export const CRITICAL_CARE_BUNDLE_PLAN_CODE =
...
export function isAdvancedHemodynamicsModuleEnabled(
  ...
  const raw =
    env.ENABLE_ADVANCED_HEMODYNAMICS_MODULE?.trim().toLowerCase();
...
export function isHemodynamicsFundamentalsTierEligible(
  tier: TierCode | string | null | undefined,
): boolean {
  return tier === "RN" || tier === "NP";
}

export function isAdvancedHemodynamicsTierEligible(
  tier: TierCode | string | null | undefined,
): tier is AdvancedHemodynamicsAllowedTier {
  return tier === "RN" || tier === "NP";
}

// ─── Plan code helpers ────────────────────────────────────────────────────────

export function isAdvancedHemodynamicsPlanCode(
  ...
  return (
    code === ADVANCED_HEMODYNAMICS_PLAN_CODE ||
