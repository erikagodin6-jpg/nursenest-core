...
export async function runSitemapSegmentationValidation(options: {
  ...
  const routeGetters: Record<string, RouteGetter> =
    ...
    ({
      ...
      "sitemap-en.xml": () => import("@/app/sitemap-en.xml/route"),
      "sitemap-fr.xml": () => import("@/app/sitemap-fr.xml/route"),
      "sitemap-es.xml": () => import("@/app/sitemap-es.xml/route"),
      "sitemap-hi.xml": () => import("@/app/sitemap-hi.xml/route"),
      "sitemap-pt.xml": () => import("@/app/sitemap-pt.xml/route"),
      "sitemap-ar.xml": () => import("@/app/sitemap-ar.xml/route"),
      "sitemap-de.xml": () => import("@/app/sitemap-de.xml/route"),
      "sitemap-jp.xml": () => import("@/app/sitemap-jp.xml/route"),
      "sitemap-ko.xml": () => import("@/app/sitemap-ko.xml/route"),
      "sitemap-zh.xml": () => import("@/app/sitemap-zh.xml/route"),
      "sitemap-zh-tw.xml": () => import("@/app/sitemap-zh-tw.xml/route"),
      "sitemap-it.xml": () => import("@/app/sitemap-it.xml/route"),
      "sitemap-tl.xml": () => import("@/app/sitemap-tl.xml/route"),
