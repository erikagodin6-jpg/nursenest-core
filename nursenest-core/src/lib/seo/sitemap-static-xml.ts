...
export async function collectCoreUrls(origin: string): Promise<string[]> {
  ...
  const base = [
    ...
    add("/exams/canada"),
    add("/exams/uk"),
    add("/exams/philippines"),
    add("/exams/india"),
    add("/india/nursing-exams"),
    add("/india/aiims-nursing"),
    add("/india/nursing-registration"),
    add("/exams/middle-east"),
    add("/middle-east/prometric-nursing-exam"),
    add("/middle-east/dha-exam"),
    add("/middle-east/haad-exam"),
    add("/middle-east/dataflow-guide"),
    add("/exams/australia"),
    add("/australia/ahpra-registration"),
    add("/australia/osce-nursing"),
    add("/australia/oba-nursing"),
    add("/australia/nursing-pathway"),
    add("/exams/china"),
    add("/china/nursing-exam"),
    add("/china/work-abroad"),
    add("/exams/korea"),
    add("/korea/nursing-exam"),
    add("/exams/japan"),
    add("/japan/nursing-exam"),
    add("/japan/how-to-become-a-nurse"),
    add("/japan/work-abroad"),
    add("/japan/nclex-for-japanese-nurses"),
    add("/exams/germany"),
    add("/germany/nurse-recognition"),
    add("/germany/kenntnisprufung"),
    add("/germany/work-as-a-nurse"),
    add("/germany/german-language-for-nurses"),
    add("/exams/france"),
    add("/france/nurse-registration"),
    add("/france/how-to-become-a-nurse"),
    add("/france/work-abroad"),
    add("/exams/italy"),
    add("/italy/nurse-registration"),
    add("/italy/how-to-become-a-nurse"),
    add("/italy/work-abroad"),
    add("/exams/hungary"),
    add("/hungary/nurse-registration"),
    add("/hungary/how-to-become-a-nurse"),
    add("/hungary/work-abroad"),
    add("/exams/portugal"),
    add("/portugal/nurse-registration"),
    add("/portugal/how-to-become-a-nurse"),
    add("/portugal/work-abroad"),
    add("/exams/mexico"),
    add("/mexico/nurse-registration"),
    add("/mexico/how-to-become-a-nurse"),
    add("/mexico/nclex-for-mexican-nurses"),
    add("/mexico/work-abroad"),
  ];
