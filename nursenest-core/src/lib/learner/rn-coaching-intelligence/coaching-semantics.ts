...
import type { CoachingModel, CoachingSemanticsCopy } from "@/lib/learner/rn-coaching-intelligence/coaching-types";

const LOFT_FORBIDDEN = /\b(adaptive readiness|adaptive estimate|standard error|theta|difficulty progression|exam got harder|exam got easier|psychometric)\b/i;
...
export function loftSafeTrendLabel(raw: string | null | undefined, model: CoachingModel, _pathwayId?: string | null): string | null {
  if (!raw) return null;
