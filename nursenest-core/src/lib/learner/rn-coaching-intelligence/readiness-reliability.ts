...
import type { CoachingModel, ReadinessReliabilityAssessment } from "@/lib/learner/rn-coaching-intelligence/coaching-types";
...
export function assessReadinessReliability(args: {
  ...
  if (coachingModel === "loft_readiness") {
    ...
    factors.push("LOFT uses fixed-length blueprint semantics — not adaptive precision");
  }
