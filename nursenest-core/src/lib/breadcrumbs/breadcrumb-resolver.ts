...
export type ResolveClinicalInterpretationHubBreadcrumbsInput = { kind: "clinical-interpretation-hub" };
export type ResolveClinicalInterpretationGuideBreadcrumbsInput = {
...
export type BreadcrumbResolverInput =
  ...
  | ResolveClinicalInterpretationHubBreadcrumbsInput
  | ResolveClinicalInterpretationGuideBreadcrumbsInput;
