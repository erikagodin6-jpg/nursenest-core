    ...
    step("recognize", {
      ...
      choices: [
        ...
        adv("d", "Order portable CXR and await before any intervention", false,
          "Tension PTX is a clinical emergency. Waiting for CXR in hemodynamic collapse kills the patient. Treat immediately.", "fatal"),
      ],
      nextKey: "decompress",
    ...
    step("recognize", {
      ...
      choices: [
        ...
        adv("d", "Switch to pressure control mode at lower PIP to reduce barotrauma while arranging transfer to bronchoscopy suite", false,
          "Lower PIP in PC with a completely obstructed ETT delivers no gas at all — it just pressurizes the obstructed dead space. The ETT must be removed immediately.", "harmful"),
      ],
      nextKey: "bvm_bridge",
    ...
    step("recognize", {
      ...
      choices: [
        ...
        adv("b", "Diphenhydramine 50 mg IV — antihistamines are first-line for anaphylaxis", false,
          "CRITICAL ERROR. Antihistamines are SECOND LINE in anaphylaxis. They treat urticaria/itching but do NOT reverse cardiovascular collapse or bronchospasm. Epinephrine first, always.", "harmful"),
        adv("c", "Hydrocortisone 500 mg IV — steroids prevent biphasic reaction", false,
          "Steroids are important for prevention of biphasic reaction but are SLOW (hours to peak effect). They are second-line, not first. Epinephrine first.", "harmful"),
