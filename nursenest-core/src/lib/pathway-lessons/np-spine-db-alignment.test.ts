...
describe("np-spine-db-alignment", () => {
  ...
  it("exact topicSlug yields high score", () => {
    const topic: NpSpineTopic = {
      id: "endo-diabetes-t2",
      title: "Type 2 diabetes management",
      exams: ["FNP"],
    };
    const lesson: PathwayLessonMatchRow = {
      id: "1",
      pathwayId: "us-np-fnp",
  ...
  it("classifies EXISTS_STRONG for dominant exact match", () => {
    const topic: NpSpineTopic = { id: "cv-hf", title: "Heart failure overview", exams: ["FNP"] };
    const lesson: PathwayLessonMatchRow = {
      id: "a",
      pathwayId: "us-np-fnp",
      slug: "cv-hf",
  ...
  it("classifies DUPLICATE_CLUSTER when two close high scores", () => {
    const topic: NpSpineTopic = { id: "cv-afib", title: "Atrial fibrillation", exams: ["FNP"] };
    const a: PathwayLessonMatchRow = {
      id: "1",
      pathwayId: "us-np-fnp",
      slug: "fnp-cv-afib-a",
  ...
  it("classifies MISSING without candidates", () => {
    const topic: NpSpineTopic = { id: "rare-orphan-topic-xyz", title: "Rare orphan topic xyz", exams: ["FNP"] };
