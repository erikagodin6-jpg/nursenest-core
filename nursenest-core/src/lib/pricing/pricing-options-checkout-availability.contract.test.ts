...
const CONFIGURED_PRICE_ENVS: Record<string, string> = {
  ...
  STRIPE_PRICE_US_NEW_GRAD_MONTHLY: "price_test_us_newgrad_monthly",
  STRIPE_PRICE_US_NEW_GRAD_6MONTH: "price_test_us_newgrad_6m",
  STRIPE_PRICE_US_NEW_GRAD_YEARLY: "price_test_us_newgrad_yearly",
  STRIPE_PRICE_US_LPN_MONTHLY: "price_test_us_lpn_monthly",
  STRIPE_PRICE_US_LPN_3MONTH: "price_test_us_lpn_3m",
  STRIPE_PRICE_US_LPN_6MONTH: "price_test_us_lpn_6m",
  STRIPE_PRICE_US_LPN_YEARLY: "price_test_us_lpn_yearly",
  STRIPE_PRICE_US_RN_MONTHLY: "price_test_us_rn_monthly",
  STRIPE_PRICE_US_RN_3MONTH: "price_test_us_rn_3m",
  STRIPE_PRICE_US_RN_6MONTH: "price_test_us_rn_6m",
  STRIPE_PRICE_US_RN_YEARLY: "price_test_us_rn_yearly",
  STRIPE_PRICE_US_NP_MONTHLY: "price_test_us_np_monthly",
  STRIPE_PRICE_US_NP_3MONTH: "price_test_us_np_3m",
  STRIPE_PRICE_US_NP_6MONTH: "price_test_us_np_6m",
  STRIPE_PRICE_US_NP_YEARLY: "price_test_us_np_yearly",
  STRIPE_PRICE_US_ALLIED_MONTHLY: "price_test_us_allied_monthly",
  STRIPE_PRICE_US_ALLIED_3MONTH: "price_test_us_allied_3m",
  STRIPE_PRICE_US_ALLIED_6MONTH: "price_test_us_allied_6m",
  STRIPE_PRICE_US_ALLIED_YEARLY: "price_test_us_allied_yearly",
};
