...
export const admissionsSliceDefinitions: AdmissionsSliceDefinition[] = [
  ...
  },
  {
    ...
    readinessItems: [
      item("hub", "Dedicated CASPer hub", true, 12, "missing", "Needs explicit CASPer route/surface."),
      item("scenario-bank", "Situational judgment scenario bank", true, 18, "missing", "Needs healthcare/non-healthcare scenarios with rubrics."),
      item("rubric", "Response rubric", true, 14, "missing", "Needs empathy/ethics/communication/scenario judgment rubric."),
      item("timed-practice", "Timed response practice", true, 12, "missing", "Needs timed written/video-style response workflow."),
      item("feedback", "Structured feedback engine", true, 14, "partial", "Can reuse AI/governance patterns; needs CASPer-specific rubric feedback."),
      item("model-answers", "Model response library", false, 8, "missing", "Needs examples that avoid memorized answer risk."),
      item("analytics", "Competency analytics", true, 10, "missing", "Needs empathy/ethics/clarity/professionalism scoring."),
      item("seo", "Public SEO landing pages", false, 6, "missing", "Needs CASPer admissions content clusters."),
