...
export const QUESTION_LOCALIZATION_PROFILES: Record<GlobalRegionSlug, LocalizationProfile> = {
  ...
  france: {
    ...
    bilingualDeliveryPreferred: true,
    toneGuidance: "Professional, precise, localized when available.",
    sensitivityNotes: ["Prefer French localization where approved"],
  },
  hungary: {
    region: "hungary",
    displayName: "Hungary",
    ...
    bilingualDeliveryPreferred: true,
    toneGuidance: "Professional, clear, localized when available.",
    sensitivityNotes: ["Prefer Hungarian localization where approved"],
  },
  portugal: {
    region: "portugal",
    ...
    bilingualDeliveryPreferred: true,
    toneGuidance: "Professional, clear, localized when available.",
    sensitivityNotes: ["Prefer Portuguese localization where approved"],
  },
  mexico: {
    region: "mexico",
    displayName: "Mexico",
    ...
    bilingualDeliveryPreferred: true,
    toneGuidance: "Professional, clear, localized when available.",
    sensitivityNotes: ["Prefer Spanish localization where approved"],
  },
  canada: {
    region: "canada",
    displayName: "Canada",
