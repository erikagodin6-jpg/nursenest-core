...
export const ECG_RHYTHM_TEMPLATES: EcgRhythmTemplate[] = [
  ...
  template("sinus_arrhythmia", "Sinus arrhythmia", [50, 100], "regularly_irregular", "present", "normal", [0.06, 0.10], ["sinus P waves with varying R-R interval", "phasic respiratory variation is common"], ["absent P waves", "flutter waves", "wide bizarre ventricular complexes"], "basic", ["RN", "PN", "RPN", "NP", "PARAMEDIC", "CARDIAC_TECH", "RESPIRATORY_THERAPY"], ["sinus", "irregular"]),
  ...
  template("junctional_rhythm", "Junctional rhythm", [40, 60], "regular", "variable", "variable", [0.06, 0.10], ["absent, inverted, or retrograde P waves", "narrow QRS with AV junctional escape focus"], ["sawtooth flutter baseline", "wide ventricular escape morphology"], "intermediate", ["RN", "NP", "PARAMEDIC", "CARDIAC_TECH"], ["junctional", "escape"]),
  ...
  template("digoxin_toxicity_pattern", "Digoxin toxicity pattern", [30, 120], "variable", "variable", "variable", [0.06, 0.16], ["scooped ST depression with bradyarrhythmia or ectopy", "AV block, junctional escape, or ventricular ectopy can coexist"], ["isolated peaked T waves", "classic contiguous STEMI elevation"], "advanced", ["RN", "NP", "PARAMEDIC", "CARDIAC_TECH"], ["drug", "toxicity", "digoxin"], true),
  template("drug_induced_qt_prolongation", "Drug-induced QT prolongation", [40, 130], "regular", "present", "normal", [0.06, 0.11], ["prolonged QT or QTc interval", "medication exposure raises torsades risk"], ["shortened QT interval", "isolated ST-elevation infarction pattern"], "advanced", ["RN", "NP", "PARAMEDIC", "CARDIAC_TECH"], ["drug", "qt", "toxicity"], true, "prolonged"),
