...
const SENTRY_SERVER_CONTEXT_FILES = [
  ...
  "app/api/learner/personalized-study-plan/route.ts",
  "app/api/learner/email-engagement-prefs/route.ts",
  "app/api/cron/learner-engagement/route.ts",
  ...
  "app/api/questions/freemium-grade/route.ts",
