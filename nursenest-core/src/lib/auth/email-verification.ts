...
/** Re-export for routes that already import from this module; implementation is shared with credentials login. */
export { normalizeEmailForDedup } from "./email-address-normalization";
