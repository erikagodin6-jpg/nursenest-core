export type TierValueKey = "rn" | "pn" | "np" | "allied" | "newgrad" | "preNursing";

export type TierValueStageKey = "learn" | "practice" | "assess" | "remediate" | "master";
  ...
  return [
    {
      ...
      body: args.learn,
      outcome: "Learners build the language, safety habits, and decision frameworks they need before they start drilling questions.",
      screenshot: SHOTS.dashboard,
      screenshotAlt: `${args.label} learner dashboard with lesson progress and study streaks`,
      links: [commonLinks.lessons, commonLinks.flashcards, commonLinks.clinical],
    },
    {
      key: "practice",
      label: "Practice",
      ...
      body: args.practice,
      outcome: "Every practice session turns mistakes into a visible next step instead of leaving learners to guess what to review.",
      screenshot: SHOTS.flashcards,
    ...
    },
    {
      key: "assess",
      label: "Assess",
      headline: "Assessment shows whether performance is holding under exam conditions.",
      body: args.assess,
      outcome: "Timed exams, CAT-style progression, LOFT-style simulation where available, and review reports help learners separate familiarity from readiness.",
    ...
    },
    {
      ...
      body: args.remediate,
      outcome: "Adaptive recommendations connect weak topics to lessons, question sets, flashcards, and review work so study time stays focused.",
      screenshot: SHOTS.coaching,
      screenshotAlt: `${args.label} coaching panel with targeted recommendations`,
      links: [commonLinks.readiness, commonLinks.lessons, commonLinks.questions],
    },
    {
      key: "master",
      label: "Master",
      ...
      body: args.master,
      outcome: "Readiness scoring, trend tracking, analytics, and performance reports show whether the learner is becoming more consistent over time.",
...
export const TIER_VALUE_EXPERIENCES: Record<TierValueKey, TierValueExperience> = {
  rn: {
    key: "rn",
    label: "RN",
    tagline: "NCLEX-RN preparation built around clinical judgment, NGN practice, and CAT readiness.",
    differentiation: "RN learners see how lessons, NGN items, rationales, CAT performance, and readiness analytics work together.",
    stages: stages({
      label: "RN",
      learn:
  ...
  pn: {
    key: "pn",
    label: "RPN / PN",
    tagline: "REx-PN, CPNRE, and PN preparation focused on foundational nursing safety and scope.",
    differentiation: "PN learners get a guided pathway that reinforces fundamentals while still preparing them for modern item formats.",
    stages: stages({
      label: "RPN / PN",
      learn:
  ...
  np: {
    key: "np",
    label: "NP",
    tagline: "Advanced preparation for CNPLE-style reasoning, decision-making, and LOFT simulation.",
    differentiation: "NP learners see advanced clinical reasoning as a connected loop: cases, assessment, remediation, and readiness.",
    stages: stages({
      label: "NP",
      learn:
      ...
      assessShot: SHOTS.catReadiness,
    }),
  },
  allied: {
    key: "allied",
    label: "Allied Health",
    tagline: "Profession-specific preparation for competency, safety, and applied clinical performance.",
    differentiation: "Allied learners get profession-aware practice instead of a generic nursing-only experience.",
    stages: stages({
      label: "Allied Health",
      learn:
  ...
  newgrad: {
    key: "newgrad",
    label: "New Grad",
    tagline: "Transition-to-practice support for confidence, specialty preparation, and safe early-career decisions.",
    differentiation: "New grads get exam-style structure plus real-world support for the first year of practice.",
    stages: stages({
      label: "New Grad",
      learn:
  ...
  preNursing: {
    key: "preNursing",
    label: "Pre-Nursing",
    tagline: "Foundations and confidence-building before nursing school starts.",
    differentiation: "Pre-nursing learners see what nursing study feels like before they commit to a full exam pathway.",
    stages: stages({
      label: "Pre-Nursing",
      learn:
...
export const TIER_VALUE_ORDER: TierValueKey[] = ["rn", "pn", "np", "allied", "newgrad", "preNursing"];
