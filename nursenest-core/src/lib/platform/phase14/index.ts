/**
 * Phase 14 autonomous clinical-education network & governance **foundations** (types only).
 *
...
export * from "@/lib/platform/phase14/autonomous-operational-intelligence";
export * from "@/lib/platform/phase14/global-infrastructure-planning";
