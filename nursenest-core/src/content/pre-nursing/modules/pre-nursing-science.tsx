...
export function ScienceFoundationsModule() {
  ...
  const celldivConcept = useEditableText("science-celldiv-concept", "Maintaining accurate DNA replication during division is essential. Checkpoints in the cell cycle catch errors. When these checkpoints fail (e.g., p53 tumor suppressor mutation), cells can proliferate uncontrollably, which is the basis of cancer development.");
