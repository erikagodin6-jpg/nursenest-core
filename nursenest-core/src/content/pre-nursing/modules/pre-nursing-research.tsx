...
import { EditableModuleText, useEditableText } from "@/components/pre-nursing/module-edit-context";
import {
  BookOpen,
  BarChart3,
  FlaskConical,
...
const foundationsQuiz: import("@/components/pre-nursing/interactive-learning").QuizQuestion[] = [
  {
    id: "rf1",
...
const statisticsQuiz: import("@/components/pre-nursing/interactive-learning").QuizQuestion[] = [
  {
    id: "rs1",
...
const designQuiz: import("@/components/pre-nursing/interactive-learning").QuizQuestion[] = [
  {
    id: "rd1",
...
const ebpQuiz: import("@/components/pre-nursing/interactive-learning").QuizQuestion[] = [
  {
    id: "re1",
...
const appraisalQuiz: import("@/components/pre-nursing/interactive-learning").QuizQuestion[] = [
  {
    id: "ra1",
...
const advancedTopicsQuiz: import("@/components/pre-nursing/interactive-learning").QuizQuestion[] = [
  {
    id: "at1",
...
const appliedQuiz: import("@/components/pre-nursing/interactive-learning").QuizQuestion[] = [
  {
    id: "rc1",
...
export function ResearchStatisticsModule() {
  ...
  const statVsClinicalContent = useEditableText("research-stat-vs-clinical", "Statistical significance means the result is unlikely due to chance (p < 0.05). Clinical significance means the result is large enough to matter in practice. A drug that lowers HbA1c by 0.1% may be statistically significant with a huge sample but clinically meaningless. You would not change treatment for 0.1%.");
          ...
          <ProgressiveReveal
            ...
            cards={[
              ...
              },
              {
                ...
                summary: "Check PICO clarity and clinical relevance.",
                detail:
                  "Is the question clear and focused? Does it use a PICO format (Population, Intervention, Comparison, Outcome)? Is it clinically relevant to your practice?",
              },
              {
                id: "ap3",
                title: "3. Evaluate the Design",
                summary: "Match design to the question (RCT, qualitative, etc.).",
                detail:
                  "Is the study design appropriate for the question? Causation questions need RCTs. Experience questions need qualitative methods. Is there a control group?",
              },
              {
                id: "ap4",
                title: "4. Examine the Sample",
                summary: "Selection, size, dropout, and power.",
                detail:
                  "How were participants selected? Is the sample representative? Is it large enough? Were there significant dropouts (attrition)? Power analysis done?",
              },
              {
                id: "ap5",
                title: "5. Scrutinize the Results",
                summary: "Effect sizes, CIs, and reporting completeness.",
                detail:
                  "Look beyond p-values. Check effect sizes, confidence intervals, and clinical significance. Are all outcomes reported, or only favorable ones (selective reporting)?",
              },
              {
                id: "ap6",
                title: "6. Consider Limitations & Applicability",
                summary: "Bias, generalizability, and your setting.",
                detail:
                  "What biases exist? Can results apply to YOUR patient population? Do the benefits outweigh risks? Is the intervention feasible in your setting?",
              },
            ]}
          />
        </MicroLesson>
