---
slug: au-np-acp-differential-diagnosis-hypotension-framework-primary-care-australia
title: "Differential diagnosis frameworks for hypotension in advanced practice in primary care across Australia: educational overview"
...
tags: ["Australia","Nurse Practitioner","Differential Diagnosis","Shock","Assessment","primary care australia"]
...
canonicalUrl: /blog/au-np-acp-differential-diagnosis-hypotension-framework-primary-care-australia
...
<h2>Introduction</h2>
<p>This guide is written in clear international English for Australian nurse practitioner candidates and advanced practice nurses preparing for registration, endorsement study, and clinically weighted exams. It connects Differential diagnosis frameworks for hypotension in advanced practice to primary care across Australia. The framing is educational: it supports learning, clinical reasoning, and workplace orientation—not individualized legal, regulatory, or medical advice. Always verify requirements with AHPRA, the Nursing and Midwifery Board of Australia (NMBA), your education provider, and your employer.</p>
...
<ul>
  ...
  <li><strong>Mechanism-first reasoning</strong>: connect Differential diagnosis frameworks for hypotension in advanced practice to assessment changes before choosing interventions, then check whether your answer fits primary care across Australia access realities.</li>
