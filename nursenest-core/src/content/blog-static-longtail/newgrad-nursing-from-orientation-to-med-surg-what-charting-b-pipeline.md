---
slug: newgrad-nursing-from-orientation-to-med-surg-what-charting-b-pipeline
title: "From Orientation to Med-Surg: What Charting Backlog Really Looks Like"
excerpt: "Production HTML for this topic lives in `data/blog-content/newgrad-prod-batch-03/body-45.html.html`."
category: New graduate nursing
tags: NCLEX, Nursing education
seoTitle: "From Orientation to Med-Surg: What Charting Backlog Really L… | NurseNest"
seoDescription: "Production HTML for this topic lives in `data/blog-content/newgrad-prod-batch-03/body-45.html.html`."
canonicalUrl: /blog/newgrad-nursing-from-orientation-to-med-surg-what-charting-b
...
<p>Production HTML for this topic lives in `data/blog-content/newgrad-prod-batch-03/body-45.html.html`.</p>

<ul>
<li>Manifest id: 63</li>
<li>Slug: `newgrad-nursing-from-orientation-to-med-surg-what-charting-backlog-really-looks-like`</li>
<li>Unit: med-surg</li>
</ul>
...
Understanding From Orientation to Med-Surg: What Charting Backlog Really Looks Like is essential for both the NCLEX exam and clinical practice. Here are the high-yield points every nursing student must know:
