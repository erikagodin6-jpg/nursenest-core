---
slug: newgrad-nursing-handling-night-shift-on-same-day-surgery-as-pipeline
title: "Handling Night Shift on Same-Day Surgery as a New Grad Nurse: First Priorities"
excerpt: "Production HTML for this topic lives in `data/blog-content/newgrad-prod-batch-03/body-36.html.html`."
category: New graduate nursing
tags: NCLEX, Nursing education, New graduate, Transition to practice
seoTitle: "Handling Night Shift on Same-Day Surgery as a New Grad Nurse… | NurseNest"
seoDescription: "Production HTML for this topic lives in `data/blog-content/newgrad-prod-batch-03/body-36.html.html`."
canonicalUrl: /blog/newgrad-nursing-handling-night-shift-on-same-day-surgery-as
...
<p>Production HTML for this topic lives in `data/blog-content/newgrad-prod-batch-03/body-36.html.html`.</p>

<ul>
<li>Manifest id: 51</li>
<li>Slug: `newgrad-nursing-handling-night-shift-on-same-day-surgery-as-a-new-grad-nurse-first-priorities`</li>
...
Understanding Handling Night Shift on Same-Day Surgery as a New Grad Nurse: First Priorities is essential for both the NCLEX exam and clinical practice. Here are the high-yield points every nursing student must know:
