      ...
      {professions.map((p) => (
        <li key={p.segment}>
          <Link
            ...
            className="group flex h-full flex-col rounded-2xl border border-[var(--theme-card-border)] bg-card p-5 shadow-sm transition hover:border-primary/35"
          >
            <h3 className="text-lg font-semibold text-[var(--theme-heading-text)] group-hover:text-primary">{p.h1}</h3>
