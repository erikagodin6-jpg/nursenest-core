...
export async function GlobalMarketingHomeIntro() {
  ...
  const headline = await resolveRegistryMarketingHeadline(DEFAULT_MARKETING_LOCALE, c.headline);
  return (
    <section
    ...
    >
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-9 lg:px-8">
        ...
        <h2 className="nn-marketing-h1 mt-2 max-w-3xl text-balance">
          <MarketingEditableI18nText messageKey="marketing.globalRoot.headline" initialDraft={headline}>
            {headline}
