...
export function HomeHeroPathGateway({ region }: Props) {
  ...
  return (
    <div
      className="mt-[var(--nn-rhythm-tight-y)] rounded-2xl border border-[var(--border-subtle)] bg-[var(--nn-presentation-panel)] p-4 shadow-[var(--shadow-card)] sm:mt-6 sm:p-5 md:p-6"
