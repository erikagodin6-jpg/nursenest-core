...
export function OsceStationCard({
  ...
  return (
    <article className="rounded-xl border border-[var(--semantic-border-soft)] bg-[color-mix(in_srgb,var(--semantic-panel-warm)_12%,var(--bg-card))] p-4">
      ...
      <div className="mt-2 flex flex-wrap gap-2 text-xs text-[var(--theme-body-text)]">
        ...
        <span className="rounded-full border border-[var(--semantic-border-soft)] px-2 py-0.5">Timed mode + checklist (shell)</span>
      </div>
