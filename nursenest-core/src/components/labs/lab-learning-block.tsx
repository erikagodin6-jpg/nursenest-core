...
const TONE_VARS: Record<LabLearningBlockTone, string> = {
...
export function LabLearningBlock({
  title,
  eyebrow,
  tone = "neutral",
  icon: Icon,
  ...
  return (
    <section
      id={id}
      className="nn-lab-block"
      style={
        {
          "--nn-lab-block-hue": hue,
        } as React.CSSProperties
      }
    >
      <header className="nn-lab-block__head">
        {Icon ? (
          <span className="nn-lab-block__icon" aria-hidden>
...
export function LabChipList({ items, variant = "default" }: { items: string[]; variant?: "default" | "medication" | "escalation" }) {
  return (
