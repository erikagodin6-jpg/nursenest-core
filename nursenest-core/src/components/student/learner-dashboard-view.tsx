          ...
          <ul className="mt-4 space-y-3 text-sm">
            ...
            <li className="flex gap-3 rounded-xl border border-border/60 bg-muted/20 p-3">
              ...
              <div>
                ...
                <Link href="/app/practice-tests" className="text-primary underline-offset-4 hover:underline">
          ...
          {!data.topicPerformanceReliable ? (
            ...
            <div className="mt-4">
              <PremiumEmptyState
                ...
                primaryCta={{ label: t("learner.dashboard.empty.openPracticeExams"), href: "/app/practice-tests", variant: "primary" }}
              />
            </div>
          )}
        </section>
