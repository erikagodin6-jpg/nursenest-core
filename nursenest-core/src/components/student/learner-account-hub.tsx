...
import { LearnerAccountPageHero } from "@/components/learner-account-ui";
  ...
  return (
    <div className="space-y-8" data-testid="learner-account-hub">
      <LearnerAccountPageHero
        ...
        title={t("learner.account.shell.title")}
        description={t("learner.account.shell.subtitle")}
        actions={
          <>
            <Link
              href="/app"
            ...
            <Link
              ...
              className="inline-flex items-center rounded-lg border border-[color-mix(in_srgb,var(--semantic-brand)_35%,var(--semantic-border-soft))] bg-[color-mix(in_srgb,var(--semantic-brand)_10%,var(--card))] px-3 py-2 text-sm font-semibold text-foreground shadow-sm hover:bg-[color-mix(in_srgb,var(--semantic-brand)_16%,var(--card))]"
            >
