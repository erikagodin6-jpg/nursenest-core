...
const DEFAULT_STUDY_LINKS: {
  ...
  { href: "/app/practice-tests?catLaunch=1", labelKey: "learner.profile.quickLinks.catPractice", icon: Crosshair, accent: "cat" },
  { href: "/app/practice-tests", labelKey: "nav.practiceExams", icon: GraduationCap, accent: "exams" },
