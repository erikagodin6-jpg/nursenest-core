...
export function buildNclexDistractors(
  ...
  missingFallback = "This choice may be plausible, but the stem does not provide the assessment finding, clinical threshold, or timing cue needed to support it over the correct answer.",
