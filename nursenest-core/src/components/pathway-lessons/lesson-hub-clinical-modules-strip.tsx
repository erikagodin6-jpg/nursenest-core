...
/**
 * Second-row study module links on marketing lesson hubs (labs, OSCE, ECG, etc.) — aligned with
 * {@link buildPremiumMarketingModuleCards} on the exam overview hub. See docs/hub-module-relocation-FINAL.md.
 */
export async function LessonHubClinicalModulesStrip({ pathway, marketingLocale, signedIn }: Props) {
