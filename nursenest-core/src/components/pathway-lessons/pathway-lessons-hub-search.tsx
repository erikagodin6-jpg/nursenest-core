    ...
    <div className="space-y-2">
      ...
      <form method="get" action={basePath} className="flex flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <input
          ...
          autoComplete="off"
          maxLength={80}
          className="min-h-11 w-full flex-1 rounded-full border border-[color-mix(in_srgb,var(--theme-primary)_10%,var(--semantic-border-soft))] bg-[var(--theme-page-bg)] px-4 py-2.5 text-sm text-foreground placeholder:text-[var(--theme-muted-text)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/25"
        />
