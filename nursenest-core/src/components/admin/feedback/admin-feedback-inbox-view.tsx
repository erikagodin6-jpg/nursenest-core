...
import {
  AdminFeedbackDuplicateForms,
  AdminFeedbackInternalNotesForm,
  AdminFeedbackQuickStatusRow,
} from "@/components/admin/feedback/admin-feedback-mutation-forms";
          ...
          <div className="rounded-2xl border border-border/70 bg-gradient-to-b from-card to-muted/10 p-5 shadow-md">
            {!selectedId ? (
              ...
              <div className="space-y-6">
                ...
                <AdminFeedbackQuickStatusRow reportId={selected.id} />
                ...
                <div className="rounded-xl border border-amber-500/25 bg-amber-500/[0.06] p-4">
                  ...
                  <AdminFeedbackDuplicateForms
                    ...
                    sp={sp}
                    hasDuplicateOf={Boolean(selected.duplicateOf)}
                  />
                ...
                <div>
                  ...
                  <AdminFeedbackInternalNotesForm reportId={selected.id} defaultNotes={selected.internalNotes ?? null} />
                </div>
