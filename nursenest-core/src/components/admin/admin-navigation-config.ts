...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/blueprint-compliance", label: "Blueprint compliance", icon: ClipboardList },
      { href: "/admin/scope-compliance", label: "Scope compliance", icon: ShieldAlert },
      ...
      { href: "/admin/question-quality", label: "Question quality", icon: ClipboardList },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/institutions", label: "Institutional licensing", icon: Building2 },
