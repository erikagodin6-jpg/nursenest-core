...
export type MatchPair = {
  /** Stable key for matching; auto-assigned from index when omitted. */
  id?: string;
  term: string;
  definition: string;
};
...
export function MatchingExercise({
  ...
  const [shuffledDefs, setShuffledDefs] = useState(() =>
    fisherYatesShuffle([...pairsWithIds])
  );
  ...
  const reset = () => {
    ...
    setSelectedTerm(null);
    setIncorrect(null);
    setShuffledDefs(fisherYatesShuffle([...pairsWithIds]));
  };
