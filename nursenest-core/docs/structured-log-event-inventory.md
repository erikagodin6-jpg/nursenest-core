...
| `entitlement_resolve_failed` | error | `resolve-entitlement-for-page.ts`, `questions/[id]/route.ts` | Yes† / async headers | Pairs with Sentry `entitlement.resolve.failure` |
