...
### Canonical / alternates / canonicalUrl sources

- src/app/(marketing)/(default)/[locale]/[slug]/[examCode]/clinical-scenarios/page.tsx
...
- src/app/(marketing)/(default)/canada/rn/nclex-rn/guide/[topic]/page.tsx
- src/app/(marketing)/(default)/canada/rpn/rex-pn/[topic]/page.tsx
- src/app/(marketing)/(default)/canada/rpn/rex-pn/page.tsx
- src/app/(marketing)/(default)/case-studies/page.tsx
- src/app/(marketing)/(default)/china/[topic]/page.tsx
- src/app/(marketing)/(default)/clinical-modules/page.tsx
- src/app/(marketing)/(default)/cnple-blueprint/page.tsx
- src/app/(marketing)/(default)/cnple-case-studies/page.tsx
...
- src/app/(marketing)/(default)/cnple-loft-testing/page.tsx
