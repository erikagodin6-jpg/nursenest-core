/**
 * Full platform regression — cd nursenest-core && npm run test:e2e:full-regression
 * Remote: PLAYWRIGHT_SKIP_WEB_SERVER=1 PLAYWRIGHT_BASE_URL=https://host npm run test:e2e:full-regression
 */
