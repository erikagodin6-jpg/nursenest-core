...
export const RRT_PHARMACOLOGY_TOPICS: PharmacologyTopic[] = [
  ...
  },
  {
    ...
    quiz: [
      { question: "A respiratory therapist is teaching a patient how to use a DPI (dry powder inhaler). What is the correct inhalation instruction?", options: ["Inhale slowly and deeply, then hold breath for 10 seconds", "Inhale quickly and forcefully to generate enough flow to disaggregate the powder", "Actuate the device during slow exhalation", "Use a spacer to improve drug delivery"], correct: 1, rationale: "DPIs are breath-actuated devices that require fast, forceful inhalation (>30-60 L/min) to create enough turbulent energy to disaggregate the powder into respirable particles. This is the opposite of MDI technique (slow, deep inhalation). Spacers are not used with DPIs — they are designed specifically for MDIs." },
      { question: "During mechanical ventilation, where should an in-line MDI adapter be placed for optimal aerosol delivery?", options: ["At the Y-connector", "At the endotracheal tube connection", "6 inches (15 cm) from the Y-connector in the inspiratory limb", "In the expiratory limb of the circuit"], correct: 2, rationale: "The MDI adapter or nebulizer should be placed approximately 6 inches (15 cm) from the Y-connector in the inspiratory limb. This position allows the aerosol bolus to accumulate in the inspiratory tubing and be delivered as a concentrated dose during the next mechanical breath, optimizing lung deposition. Placing it at the Y-connector or ETT reduces deposition efficiency." }
    ]
  },
  {
