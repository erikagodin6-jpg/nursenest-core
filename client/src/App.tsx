  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      <Switch>
        ...
        <Route path="/mock-exams/:id/report">{() => <PremiumFeatureErrorBoundary featureName="exams" fallbackPath="/en/practice-exams"><ProtectedRoute contentType="exam" killSwitchKey="mockExams"><MockExamReport /></ProtectedRoute></PremiumFeatureErrorBoundary>}</Route>
        <Route path="/mock-exams/:id">{() => <PremiumFeatureErrorBoundary featureName="exams" fallbackPath="/en/practice-exams"><ProtectedRoute contentType="exam" killSwitchKey="mockExams" safeModeRenderer={() => <SafeExamFallback onBack={() => window.location.href = "/en/practice-exams"} />}><ExamErrorBoundary examContext={{ examType: "mock-exam" }}><Suspense fallback={<ExamLoadingFallback />}><MockExamSession /></Suspense></ExamErrorBoundary></ProtectedRoute></PremiumFeatureErrorBoundary>}</Route>
        <Route path="/practice-exams">{() => <PremiumFeatureErrorBoundary featureName="exams" fallbackPath="/en/dashboard"><ProtectedRoute contentType="exam" killSwitchKey="mockExams"><MockExamsPage /></ProtectedRoute></PremiumFeatureErrorBoundary>}</Route>
        <Route path="/mock-exams">{() => <Redirect to="/practice-exams" />}</Route>
