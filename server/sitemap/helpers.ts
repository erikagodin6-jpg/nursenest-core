...
const SITEMAP_SLUG_MAP: Record<string, Record<string, string>> = {
  ...
  fr: {
    ...
    "/lessons": "/lecons",
    "/practice-exams": "/examens-pratiques",
    "/glossary": "/glossaire",
    "/about": "/a-propos",
  ...
  es: {
    ...
    "/lessons": "/lecciones",
    "/practice-exams": "/examenes-de-practica",
    "/glossary": "/glosario",
    "/about": "/acerca-de",
    "/contact": "/contacto",
  ...
  th: {
    ...
    "/lessons": "/bot-rian",
    "/practice-exams": "/khaw-sop-chamlong",
    "/glossary": "/sap-banyat",
    "/about": "/kiao-kap-rao",
    "/contact": "/tidtaw",
  ...
  tr: {
    ...
    "/lessons": "/dersler",
    "/practice-exams": "/deneme-sinavlari",
    "/glossary": "/sozluk",
    "/about": "/hakkimizda",
    "/contact": "/iletisim",
...
export function getSharedStaticRoutes(today: string): StaticRouteDefinition[] {
  const multilingualRoutes: Omit<StaticRouteDefinition, "multilingual">[] = [
    ...
    { path: "/practice-exams", priority: "0.8", changefreq: "weekly", lastmod: today },
