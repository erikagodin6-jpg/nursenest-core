...
const freeTierConfig: TierUiConfig = {
  ...
  navItems: [
    ...
    { label: "Sample Exams", key: "SampleExams", path: "/practice-exams" },
...
const rpnTierConfig: TierUiConfig = {
  ...
  navItems: [
    ...
    { label: "Lessons", key: "Lessons", path: "/lessons" },
    { label: "Test Bank", key: "TestBank", path: "/question-bank" },
    { label: "Exams", key: "Exams", path: "/practice-exams" },
    { label: "Mock Exams", key: "MockExams", path: "/practice-exams" },
