 ...
 * ../../data/blog-content/newgrad-prod-batch-01/ (repo root) into BlogPost (Prisma).
 *
...
import type { BlogSeoBundle } from "../src/lib/blog/blog-seo-automation";
import { buildSchemaSummaryPayload } from "../src/lib/blog/blog-seo-automation";

const __dirname = path.dirname(fileURLToPath(import.meta.url));
/** Outer repo root (parent of this Next.js app). */
const REPO_ROOT = path.join(__dirname, "..", "..");
const BATCH_DIR = path.join(REPO_ROOT, "data/blog-content/newgrad-prod-batch-01");
