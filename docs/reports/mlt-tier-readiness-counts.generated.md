...
_Generated: 2026-05-11T04:08:17Z. Run: `npx tsx scripts/mlt-tier-readiness-inventory.mts`._
## Scope
...
- **Lesson scope note**: `allied_profession_key` is absent or unreadable in this database — lesson totals are **allied-core pathway only** (not MLT-filtered).
