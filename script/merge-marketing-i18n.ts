 ...
 * - `client/public/i18n/{lang}.json` (Vite monolith SPA)
 * - `nursenest-core/public/i18n/{lang}/*.json` — domain shards for Next.js (see `shared/i18n-shard-policy.ts`)
 */
export function mergeMarketingIntoI18n(): void {
  ...
  const keyTsPath = path.join(root, "nursenest-core/src/lib/i18n/marketing-message-keys.generated.ts");
  const keyTsBody =
