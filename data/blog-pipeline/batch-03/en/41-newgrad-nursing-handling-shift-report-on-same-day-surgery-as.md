...
Production HTML for this topic lives in `data/blog-content/newgrad-prod-batch-03/body-41.html.html`.

- Manifest id: 59
- Slug: `newgrad-nursing-handling-shift-report-on-same-day-surgery-as-a-new-grad-nurse-first-priorities`
